            ...
            <table class="table table-striped" id="tb-editar">
                <thead>
                 ...
                 <?php
                            ...
                            $query = "SELECT count(*) as Total, case when Genero = '1' THEN 'MASCULINO' ELSE 'FEMENINO' END AS Genero  FROM `tbvisitas` GROUP by Genero;
                             ";
                            $resultados = $conexion->query($query);
                            while ($row = $resultados->fetch_assoc()) { 
                        ?>
            ...
            <table class="table table-striped" id="tb-editar">
                <thead>
                 ...
                 <?php
                            ...
                            $query = "SELECT DISTINCT COUNT(v.Id) AS Alcanzadas, p.Pais from tbvisitas as v join tbcpais as p on v.Pais=p.codigo_pais GROUP BY p.Pais;
                             ";
                            $resultados = $conexion->query($query);
                            while ($row = $resultados->fetch_assoc()) { 
                        ?>
