    ...
    <section>
        <div class="contenedor">
            <div class="Acciones" style="text-align:center;">
              ...
              <p style="color:#D08512; text-align:center; font-size:35px; font-family:Arial Black;">VIRTUELLE GEBETSRÄUME VERFÜGBAR</p>
            </div>
        </div>
    </section>
        ...
        <div class="contenedor">
                 ...
                 <?php
                            ...
                            tbcpais p on i.Pais=p.codigo_pais
                             WHERE s.Estado = 1 and s.Idioma = 3";
                            $resultados = $conexion->query($query);
                            while ($row = $resultados->fetch_assoc()) { 
                        ?>
                        <H2><img style="width:3%;" src="../image/manos.png" alt=""> <a href="../administrador/procesos/germany-process/registrar-germany.php?IdIntercesor=<?php echo $row['Codigo']; ?>" class="href" style="text-decoration:none; font-size:15px; font-family:Cooper Black; color:gray;"><?php echo $row['Nombre_sala']; ?>s ZIMMER <?php echo $row['Pais']; ?></a></H2>
                        <?php
                            }
                        ?>
        </div>
