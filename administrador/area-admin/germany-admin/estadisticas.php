            ...
            <table class="table table-striped" id="tb-editar">
                <thead>
                 ...
                 <?php
                            ...
                            $query = "SELECT DISTINCT COUNT(*) AS Total, 
                              Case when Genero = 1 THEN 'MASCULINO' ELSE 'FEMENINO' END as Genero 
                              from tbvisitas 
                              order by Genero;
                             ";
                            $resultados = $conexion->query($query);
            ...
            <table class="table table-striped" id="tb-editar">
                <thead>
                 ...
                 <?php
                            ...
                            $query = "SELECT DISTINCT COUNT(*) AS Alcanzadas,
                                        p.Pais
                                        from tbvisitas v JOIN
                                        tbcpais as p on v.Pais=p.codigo_pais
                                        ORDER BY p.Pais;
                             ";
                            $resultados = $conexion->query($query);
                            while ($row = $resultados->fetch_assoc()) { 
