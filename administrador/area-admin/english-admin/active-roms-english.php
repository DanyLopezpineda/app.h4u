                ...
                <thead>
                 ...
                 <?php
                        ...
                        <tr>
                            ...
                            <td class="EdiWeb">
                                <button type="button" class="btn btn-warning"><a style="text-decoration:none; color:white;" href="../../procesos/english-process/edit-rooms-english.php?Idsalas=<?php echo $row['Codigo_sala']; ?>">Edit</button>
                                <button type="button" class="btn btn-danger"><a style="text-decoration:none; color:white;" href="../../procesos/english-process/disabled-room-admin.php?Idsalas=<?php echo $row['Codigo_sala']; ?>">Disabled Room</button>
                            </td>
                        </tr>
                        <?php
                            }
