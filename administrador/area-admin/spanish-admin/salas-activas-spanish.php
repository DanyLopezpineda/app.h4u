...
<head>
	<meta charset="utf-8">
	<title>Salas Virtuales Activas - Here4you</title>
    ...
    <section>
        <div class="contenedor">
            <div class="titulo-intercesores">
                <h2>Control de Salas Virtuales Activas - Here4you</h2>
            </div>
        </div>
    </section>
    <section>
                ...
                <thead>
                 ...
                 <?php
                            ...
                            case when s.Estado = 0 then 'Inactiva' else 'Activa'
                             ...
                             where cc.Id_continente=1 and s.Estado  = 1
                             ";
                        ...
                        <tr>
                            ...
                            <td class="EdiWeb">
                              ...
                              <button type="button" class="btn btn-danger"><a style="text-decoration:none; color:white;" href="../../procesos/spanish-process/deshabilitar-salas-admin.php?Idsalas=<?php echo $row['Codigo_sala']; ?>">Deshabilitar Sala</a> </button> 
                            </td>
                        </tr>
                        <?php
                            }
