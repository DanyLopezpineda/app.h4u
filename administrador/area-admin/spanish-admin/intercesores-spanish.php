            ...
            <table class="table table-striped" id="tb-editar">
                <thead>
                 ...
                 <?php
                            ...
                            $query = "SELECT i.Codigo, i.Intercesor, p.Pais, Case when i.Rol = 0 then 'xxx xxx xxx' else i.Telefono end as Telefono, Case when i.Rol = 0 then 'xxx xxx xxx' else i.Clave end as Clave, CASE WHEN i.Rol = 0 THEN 'Administrador' else 'Intercesor' end AS Rol,
                                ...
                                where i.Estado in (1,0) and p.Continente in (1,2)
