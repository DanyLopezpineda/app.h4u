                ...
                <thead>
                 ...
                 <?php
                        ...
                        <tr>
                            ...
                            <td class="EdiWeb">
                                <button type="button" class="btn btn-warning"><a style="text-decoration:none; color:white;" href="../../procesos/spanish-process/modificar-salas-spanish.php?Idsalas=<?php echo $row['Codigo_sala']; ?>">Modifier</a></button> 
                                <button type="button" class="btn btn-danger"><a style="text-decoration:none; color:white;" href="../../procesos/french-process/desactiver-salles-french.php?Idsalas=<?php echo $row['Codigo_sala']; ?>">Désactiver la salle</a></button>
                            </td>
                        </tr>
                        <?php
                            }
