...
?>
                ...
                <h3>Demande de chambre</h3>
                    ...
                    <input type="hidden" name="Idioma" value="4" readonly>
                    <p>Nom:</p>
                    <input type="text" name="Nombre" placeholder="Écrivez votre nom">
          <label for="Pais" class="form-label">Pays:</label>
                    <select name="Pais_codigo" class="form-control" require>
                                <?php
                                include '../conexion.php';

                                $consulta = "SELECT * FROM tbcpais where Continente in (3,6)";
                    ...
                    <input type="submit" value="Montez" name="btn">
                </form>
                </div>
            </div>
    </section>
