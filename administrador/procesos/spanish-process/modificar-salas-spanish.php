...
?>
                <form method="POST" action="proceso-modificar-sala-spanish.php?Idsalas=<?php echo $row['Codigo_sala']; ?>" enctype="multipart/form-data">
                <h3>Editar Sala</h3>
                    <p>Codigo Sala:</p>
                    ...
                    <p>Url:</p>
                    <input type="text" name="Url" placeholder="Ingrese la Url de la plataforma" value="<?php echo $row['Url']; ?>" require>
                    <p>Lenguaje</p>
