...
<head>
	<meta charset="utf-8">
	<title>Application - Here4you</title>
...
?>
                ...
                <h3>Virtual Room Request</h3>
                    ...
                    <input type="hidden" name="Idioma" value="2" readonly>
                    <p>Name:</p>
          ...
          <label for="Pais" class="form-label">Country:</label>
                    <select name="Pais_codigo" class="form-control" require>
                                ...
                                $consulta = "SELECT * FROM tbcpais where Continente = 3";
                    ...
                    <input type="submit" value="GET IN" name="btn">
                </form>
                </div>
            </div>
    </section>
